// The diff here is basically just removing the ethWeb3Provider and 
// changing zk.Wallet -> zk.Signer, maybe can be a PR instead of it's own library?
...
import { isHttpNetworkConfig, isValidEthNetworkURL } from '@matterlabs/hardhat-zksync-deploy/dist/utils';
import { loadCache, saveCache } from '@matterlabs/hardhat-zksync-deploy/dist/deployment-saver';
import { ETH_DEFAULT_NETWORK_RPC_URL } from '@matterlabs/hardhat-zksync-deploy/dist/constants';

import { ZkSyncDeployPluginError } from '@matterlabs/hardhat-zksync-deploy/dist/errors';
